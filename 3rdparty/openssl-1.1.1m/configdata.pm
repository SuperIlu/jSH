...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "Configurations/00-base-templates.conf", "Configurations/50-djgpp.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  includes => [  ],
  lflags => [  ],
  lib_defines => [ "OPENSSL_BN_ASM_PART_WORDS", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "MD5_ASM", "RMD160_ASM", "AESNI_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)i586-pc-msdosdjgpp-gcc",
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_MD2", "OPENSSL_NO_RC5" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_NONE", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_TESTS", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [ "OPENSSL_SYS_MSDOS" ],
  openssl_thread_defines => [  ],
  openssldir => "",
  options => "--with-rand-seed=none enable-weak-ssl-ciphers 386 no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-md2 no-msan no-pic no-rc5 no-sctp no-shared no-sse2 no-ssl-trace no-ssl3 no-ssl3-method no-tests no-threads no-ubsan no-unit-test no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.30.0",
  perlargv => [ "--with-rand-seed=none", "no-threads", "no-hw", "no-shared", "enable-weak-ssl-ciphers", "no-tests", "386", "DJGPP" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
...
our %target = (
  ...
  CFLAGS => "-fomit-frame-pointer -Os -Wall",
  HASHBANGPERL => "/usr/bin/env perl",
  RANLIB => "CODE(0x555bb911f4c8)",
  RC => "windres",
  _conf_fname_int => [ "Configurations/00-base-templates.conf", "Configurations/50-djgpp.conf", "Configurations/shared-info.pl" ],
  ...
  lflags => "-L../watt32-2.2dev.rel.11/lib -L../../watt32-2.2dev.rel.11/lib",
  lib_cflags => "",
  lib_cppflags => "",
  lib_defines => [  ],
